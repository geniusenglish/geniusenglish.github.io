...
const teacherGuides = {
  ...
  summary:
    "Kipper plans a fun party for his toys. He gets ready for the party. He has fun with his toys.\n\n키퍼는 장난감들을 위해 즐거운 파티를 준비합니다. 키퍼는 파티를 준비합니다. 키퍼는 장난감들과 즐거운 시간을 보냅니다.",
  ...
  writing: [
    "First, Kipper plans a party for his toys.",
    "Next, he gets ready for the party.",
    "Finally, he has fun with his toys."
  ]
...
"anewdog": {
  ...
  writing: [
    "First, the family wants a new dog.",
    "Next, they look at different dogs.",
    "Finally, they choose the right dog."
  ]
...
"spots": {
  ...
  summary:
    "Everyone finds spots. They look at the spots. The spots make everyone surprised and happy.\n\n모두가 점을 발견합니다. 모두가 점을 살펴봅니다. 점 때문에 모두가 놀라고 즐거워합니다.",
  ...
  writing: [
    "First, everyone finds spots.",
    "Next, they look at the spots.",
    "Finally, everyone has fun."
  ]
...
"floppysbath": {
  ...
  questions: [
    ...
    [
      "Does Floppy get clean?",
      "Yes, he does."
    ],
    [
      "How does Floppy feel after his bath?",
      "He feels fresh."
    ],
    [
      "Did you like the book?",
  ...
  writing: [
    "First, Floppy has a bath.",
    "Next, he gets clean.",
    "Finally, he feels fresh."
  ]
